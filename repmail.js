...
app.post('/generate', (req, res) => {
  ...
  const response_text = '<center><h2 style="font-weight: 600; font-size: 3vw; color:white;">Résultat :</h2></center><br><pre style="color:white; font-size: 15px;   line-height: 2; word-wrap: break-word;">'+ body.choices[0].message.content +'</pre>';
